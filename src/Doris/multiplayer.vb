...
Partial Class multiplayer
    ...
    Private GameBoard1 As TetrisBoard
    Private FallingBlock1 As TetrisBlock
    Private PreviewBoard1 As TetrisBoard
    Private PreviewBlock1 As TetrisBlock

    Private Score1 As Double
    Private Level1 As Integer
    Private Speed1 As Integer
    Private Lines1 As Integer
...
#Region "Event Handlers"
    Private Sub TetrisGame_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        PreviewBoard1 = New TetrisBoard(PreviewBox1)
        With PreviewBoard1
            .Rows = 4
            .Columns = 4
            .CellSize = New Size(20, 20)
            ...
            .SetupBoard()
        End With
        PreviewBlock1 = New TetrisBlock(PreviewBoard1)
        PreviewBlock1.CenterCell = PreviewBoard1.Cells(2, 2)
        PreviewBlock1.Shape = GetRandomShape()
        ...
        GameBoard1 = New TetrisBoard(GameBox1)
        With GameBoard1
            .Rows = 20
            .Columns = 10
            .CellSize = New Size(20, 20)
            ...
            .SetupBoard()
        End With
        FallingBlock1 = New TetrisBlock(GameBoard1)

        HelpLabel1.Text = HelpLabel1.Text.Replace("|", vbCrLf)
        StylesLabel1.Text = StylesLabel1.Text.Replace("|", vbCrLf)
        ShowMessage(String.Format("{0}W E L C O M E{0}{0}T O{0}{0}T E T R I S{0}{0}{0}{0}Click here to start new game", vbCrLf))
    ...
    Private Sub MessageLabel1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MessageLabel.Click
        Select Case Status
            Case GameStatus.Stopped
                StartNewGame()
            Case GameStatus.Paused
